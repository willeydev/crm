...
class AddressServiceTest extends UnitTestCase
{
    ...
    private MockInterface $cepService;
    ...
    protected function setUp(): void
    {
        ...
        $this->cepService      = Mockery::mock(CepGatewayInterface::class);
        ...
        $this->customer     = new Customer(['id' => 1, 'user_id' => 10]);
        $this->customer->id = 1;
    }
    ...
    public function test_create_looks_up_cep_and_saves_address(): void
    {
        ...
        $address = new Address(array_merge($cepData, ['customer_id' => 1, 'number' => '1000']));
    ...
    public function test_update_without_new_cep_updates_only_given_fields(): void
    {
        ...
        $address->id = 5;
        $updated     = new Address(['number' => '999']);
        ...
        $this->cepService->shouldNotReceive('lookup');
    ...
    public function test_update_with_new_cep_fetches_cep_and_merges_data(): void
    {
        $cepData = $this->fakeCepData();
        $address     = new Address(['number' => '1']);
        $address->id = 5;
        $updated     = new Address(array_merge($cepData, ['number' => '200']));
    ...
    public function test_delete_throws_404_when_address_not_owned(): void
    {
        $this->customerService
            ->shouldReceive('findOwned')
            ->once()
